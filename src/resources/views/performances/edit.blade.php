            ...
            <form action="{{ route('performances.update', $performance->id) }}" method="POST">
                ...
                <div class="create-container">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sub_title" value="{{ old('sub_title', $performance->sub_title) }}"
                            placeholder="例：第〇回公演" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" value="{{ old('title', $performance->title) }}" required
                            placeholder="例：夏の夜の夢" class="form-control">
                    </div>
                            ...
                            @forelse($performance->schedules as $index => $schedule)
                                <div class="seat-item dynamic-item" data-index="{{ $index }}">
                                    ...
                                    <input type="number" name="schedules[{{ $index }}][capacity]"
                                        ...
                                        placeholder="例：50" class="form-control">
                                </div>
                            @empty
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-unit-wrapper">
                            <input type="number" name="max_tickets_per_person"
                                value="{{ old('max_tickets_per_person', $performance->max_tickets_per_person) }}"
                                min="1" class="form-control"><span class="unit">枚</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="end_of_reservation_at"
                            value="{{ old('end_of_reservation_at', $performance->end_of_reservation_at ? \Carbon\Carbon::parse($performance->end_of_reservation_at)->format('Y-m-d\TH:i') : '') }}"
                            class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="notes" rows="3" placeholder="開場時間や会場に関する注意事項など"
                            class="form-control">{{ old('notes', $performance->notes) }}</textarea>
                    </div>
